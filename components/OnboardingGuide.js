...
exports.OnboardingGuide = void 0;
var react_1 = require("react");
var OnboardingGuide = function (_a) {
    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-lg shadow-xl p-8 w-full max-w-lg relative border border-gray-700 text-white">
                ...
                <button onClick={onComplete} className="w-full mt-8 px-4 py-2 bg-pink-600 text-white font-bold rounded-lg hover:bg-pink-700 transition-transform transform hover:scale-105">
                    Get Started
                </button>
            </div>
        </div>);
};
exports.OnboardingGuide = OnboardingGuide;
