...
var GitHubConnector = function (_a) {
    ...
    return (<div>
            ...
            <div className="flex flex-col items-center">
                <GitHubIcon_1.GitHubIcon className="w-12 h-12 mb-4"/>
            ...
            <button onClick={handleConnect} disabled={loading} className="w-full flex items-center justify-center p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-200 text-white font-bold disabled:bg-gray-900 disabled:cursor-not-allowed border border-gray-600">
                {loading ? <SpinnerIcon_1.SpinnerIcon /> : 'Continue with GitHub'}
            </button>
        </div>);
};
